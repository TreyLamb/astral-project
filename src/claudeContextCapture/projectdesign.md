...
- This folder (`src/claudeContextCapture/`) currently holds only design docs. If Option A or B end up needing app-side code (e.g., a page to configure/view captures), follow the standard "adding a new React page" steps in root `CLAUDE.md` — this doc does not replace that checklist.
