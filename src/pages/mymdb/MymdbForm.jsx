    ...
    <div className="mdb-form-page">
      ...
      <div className="mdb-form-card">
        <form onSubmit={handleSubmit} noValidate>
          ...
          {/* Cover image / video */}
          <div className="mdb-form-group">
            <label className="mdb-form-label" htmlFor="mdb-cover-url">Cover Image or YouTube URL</label>
            <input
              id="mdb-cover-url"
              type="text"
              className="mdb-form-input"
              placeholder="Paste image URL or YouTube / Shorts link…"
              value={coverUrlInput}
            ...
            <div className="mdb-cover-upload-fallback">
              ...
              <button
                type="button"
                className="mdb-cover-upload-link"
                onClick={() => coverInputRef.current?.click()}
              >upload an image file</button>
