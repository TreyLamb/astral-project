...
**⚠️ Finding 2026-08-06 — the 14-cycle framework does not fit the test date.** `acft-2mile-training-plan.md`'s progression table (14 cycles, checkpoints at C3/C6/C9/C12, taper in C14) was written when the cycle was **11 days** — that doc says so itself. It was never re-checked after the move to 13 days. There are **127 days** from Cycle 3 Day 1 (Aug 27) to test day (Dec 31):
