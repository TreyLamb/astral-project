...
This is **doc §17 Phases 3 + 4** of `src/pages/orbit/Guidelines_Scheduler.md` (referred to below as "the spec"; the relevant deep sections are **§7 batching, §10 step 5, §12 feedback→rules**).
...
- **Do NOT update** the project memory file (it lives outside these repos). DO update the "Where it stands" block at the top of `Guidelines_Scheduler.md` when you finish.
