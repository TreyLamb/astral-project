...
This is **doc §17 Phase 6** of `src/pages/orbit/guidelinesScheduler.md` (the "spec"). Deep section: **§7 (travel & places DB, `departure_time`, cost guard, seeding)**, with **§19 (holidays)** as an adjacent consideration.
