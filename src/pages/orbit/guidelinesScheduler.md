...
to `guidelinesOrbit.md`.

**Read `featuredesign.md` and `guidelinesOrbit.md` before building against this.**
...
live in `views/specialPrompts/phase7…9*.md` (build-phase 7 = §17 P3+P4 = this batch; 8 = §17 P5;
9 = §17 P6).
...
`views/specialPrompts/phase8DayAdjustmentsAndRouteMap.md` and `phase9GoogleTrafficAndSeeding.md` for the self-contained build prompts.
