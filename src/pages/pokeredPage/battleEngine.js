...
import TRAINER_AI_TABLES from './extractedOgData/trainerAiTables.json';
...
// unused no-op (trainerAiTables.json _notes.layer4). See extractedOgData/
// trainerAiTables.json for the full trace this was ported from.
