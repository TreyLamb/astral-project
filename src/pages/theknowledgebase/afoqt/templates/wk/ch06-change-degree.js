...
registerWords([
  ...
  },
  {
    ...
    gloss: 'so small or worthless as to be beneath consideration; barely enough',
    answer: 'trifling',
    antonym: 'generous',
    related: 'cheap',
    decoy: 'electric',
    confusable: { word: 'poultry', meaning: 'avian' },
    note: 'Paltry is about VALUE - an amount so small it feels insulting (a paltry raise). Ersatz is about AUTHENTICITY - a fake substitute standing in for the real thing (ersatz coffee), regardless of price.',
  ...
  },
  {
    ...
    note: 'Meager is about AMOUNT - not enough of something (meager rations). Tenuous is about STRENGTH or SUBSTANCE - something thin and easily broken, often used for an argument or connection, not a quantity.',
  ...
  },
  {
    ...
    gloss: 'far greater than what is reasonable or fair, especially in cost',
    answer: 'excessive',
    antonym: 'reasonable',
    related: 'wealthy',
    decoy: 'green',
  ...
  },
  {
    ...
    gloss: 'extremely small or scanty in amount; too thin to be enough',
    answer: 'sparse',
    antonym: 'copious',
    related: 'narrow',
    decoy: 'curved',
