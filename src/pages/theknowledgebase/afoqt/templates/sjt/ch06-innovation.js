...
// report honestly and ship fewer rows rather than pad. Five scenarios below, all genuinely
// distinct "propose/champion a new idea" or "weigh a calculated risk" situations - deliberately
// NOT variations on "you notice an outdated process," which is exactly the thin, generic frame
// PART 24 warned reads more like leadership/delegation than real innovation judgment. All five
// sit at band 3, the minimum needed for scenarioTemplates to produce anything at all; there was
// not enough genuinely distinct, well-grounded material found to also stretch to bands 2 and 4
// without either padding or forcing an artificial difficulty label onto content that doesn't
// actually vary in how contested it is.
...
scenarioTemplates({ chapter: CH, band: 3, idBase: 'sjt-06-b3', name: 'Innovation' });
