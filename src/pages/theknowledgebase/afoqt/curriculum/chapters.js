 ...
 *   OTHER" - every chapter below is deliberately `prereqs: []`. `isUnlocked()` still exists and
 *   still works (every() on an empty array is vacuously true), so the mechanism is intact - it
 *   is just switched off everywhere on purpose. Do not "helpfully" restore a prereq DAG.
...
export const CHAPTERS = [
  ...
  },
  {
    ...
    minutes: 9, bands: [2, 3], prereqs: [], testOutPass: 4,
  ...
  },
  {
    ...
    minutes: 10, bands: [1, 3, 4], prereqs: [], testOutPass: 4,
  ...
  },
  {
    ...
    minutes: 12, bands: [1, 3, 4], prereqs: [], testOutPass: 4,
  ...
  },
  {
    ...
    minutes: 16, bands: [2, 3, 4], prereqs: [], testOutPass: 4,
  ...
  },
  {
    ...
    minutes: 13, bands: [3, 4], prereqs: [], testOutPass: 4,
  ...
  },
  {
    ...
    minutes: 15, bands: [1, 2, 3, 4], prereqs: [], testOutPass: 5,
  ...
  },
  {
    ...
    minutes: 12, bands: [2, 3], prereqs: [], testOutPass: 4,
  ...
  // than anywhere else in the curriculum - there is no easier chapter downstream to catch it.
  {
    ...
    minutes: 16, bands: [4, 5], prereqs: [], testOutPass: 5,
  ...
  },
  {
    ...
    minutes: 0, bands: [3, 4, 5], prereqs: [], testOutPass: 5,
